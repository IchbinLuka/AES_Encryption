...
public class AESGUI extends Frame {
    ...
    public void start() throws Exception
    {
        ...
        if(!encrypt)
        {
            ...
            if(!encryptedFile.delete()) new ErrorMessage("Something went wrong!");
        }
        else
        {
            ...
            if(!compressedFile.delete()) new ErrorMessage("Something went wrong!");
        }
    }
    ...
    public static void main(String[] args) {
        new AESGUI("AES Encryption v1.0");
    }
}